...
function custom_theme_options() {
  ...
  $custom_settings = array(
    ...
    'sections'        => array(
      ...
      array(
        'id'          => 'custom_settings',
        'title'       => __( 'Custom Settings', 'theme-text-domain' )
      )
    ),
    'settings'        => array(
      ...
      array(
        ...
        'std' => 'KIT. All right reserved.'
      ),
      /*array(
        'id' => 'social_icon_links',
        'label' => 'Footer Socila Links',
        'desc' => 'Footer Social media links',
        'type' => 'social-links',
        'section' => 'footer_settings'
      ),*/
      array(
        ...
        'settings' => array(
            ...
            'type' => 'text',
            'label' => 'Icon Name',
            'desc' => 'The theme using font awesome icon',
            ),
            array(
            'id' => 'icon_link',
            'type' => 'text',
      ...
      array(
        ...
        'desc' => 'Write your own JavaScript here',
